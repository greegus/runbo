...
<template>
  <!-- Tapping outside or pressing Escape is a skip, never a silent cancel. -->
  <BottomSheet :open="open" labelled-by="readiness-title" @dismiss="skip">
    ...
    <p v-if="advice" class="rounded-lg border border-accent-200 bg-accent-50 p-3 text-sm text-accent-800" role="status">
      {{ advice }}
    </p>
